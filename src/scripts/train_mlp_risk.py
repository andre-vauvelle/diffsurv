...
from data.datamodules import DataModuleMLM, DataModuleAssessmentRiskPredict
from data.datasets import DatasetAssessmentRiskPredict
...
def cli_main():
    cli = CustomLightningCLI(
        MultilayerMLM, DataModuleAssessmentRiskPredict, seed_everything_default=42,
