...
if __name__ == '__main__':
    data_module = DataModuleMLM(token_col='phecode',
                                label_col='phecode',
                                token_vocab_path=os.path.join(DATA_DIR, 'processed', 'omop',
                                                              'phecode_vocab_top100_105.pkl'),
                                label_vocab_path=os.path.join(DATA_DIR, 'processed', 'omop',
                                                              'phecode_vocab_top100_105.pkl'),
